...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Henüz hiçbir destek talebi oluşturmadınız",sInfo:"_TOTAL_ kayıttan  _START_ ile _END_ arası gösteriliyor",sInfoEmpty:"0 kayıttan 0 tanesi gösteriliyor",
sInfoFiltered:"(Toplam _MAX_ kayıttan filtrelendi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Liste başına _MENU_ kayıt göster",sLoadingRecords:"Yükleniyor..",sProcessing:"İşleniyor",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Eşleşen kayıt bulunamadı"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
