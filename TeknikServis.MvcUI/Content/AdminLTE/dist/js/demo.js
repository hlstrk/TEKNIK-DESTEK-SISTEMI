...
(function ($) {
  ...
  $container.append(
    '<h5>Temayi Duzenle</h5><hr class="mb-2"/>'
  )
  ...
  var $dark_mode_checkbox = $('<input />', {
    ...
    if ($(this).is(':checked')) {
        ...
        document.cookie = "darkmode=dark-mode;";
    } else {
        $('body').removeClass('dark-mode')
        document.cookie = "darkmode='';";
    }
  })
    var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>Karanlik Mod</span>')
